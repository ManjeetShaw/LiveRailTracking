...
const styles = {
  ...
  input:     { width: '100%', padding: '12px 16px', marginBottom: 12, border: '1px solid #ddd', borderRadius: 8, fontSize: 14, boxSizing: 'border-box' },
  btn:       { width: '100%', padding: '12px 0', background: '#ff6f00', color: '#fff', border: 'none', borderRadius: 8, fontSize: 16, fontWeight: 'bold', cursor: 'pointer' },
